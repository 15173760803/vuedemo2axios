...
<div>
 <div class="page2-com">
       <!-- <ZuJian :zi='fun1number' :zi2='tishi'></ZuJian> -->
    ...
    methods: {
        ...
        fun1(){
            var timeout=setTimeout(()=>{
                ...
                this.$store.state.toast.zi=false;
               console.log(  this.$store.state.toast.zi);
            },2000)
         ...
         if(this.inputtext==''){
            ...
            // this.tishi="手机号不能为空"
             this.$store.state.toast.zi=true;
               this.$store.state.toast.zi2='手机号不能为空';
            console.log("aaaaa");
            timeout;
            return false;
            ...
            //    this.fun1number=true;
                // this.tishi="手机号格式不正确";
               this.$store.state.toast.zi=true;
                 this.$store.state.toast.zi2='手机号格式不正确';
                console.log("qqqqq");
               timeout;
             return false;
         }else{
    ...
    fun2(){
        ...
        //   this.fun1number=true;
          ...
          this.$store.state.toast.zi2='手机号不能为空';
            ...
            // this.tishi="密码不能为空"
              this.$store.state.toast.zi=true; 
               this.$store.state.toast.zi2='密码不能为空'
           timeout2;
            }else if(this.pwd != this.rpwd){
            //   this.fun1number=true;
            //   this.tishi="两次密码不同"
              this.$store.state.toast.zi=true;
               this.$store.state.toast.zi2='两次密码不同'
              timeout2;
            }else{
                ...
                // this.tishi="注册成功"
                 this.$store.state.toast.zi=true;
               this.$store.state.toast.zi2='注册成功'
                timeout2;
